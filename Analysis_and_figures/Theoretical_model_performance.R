...
pdf(paste0(analysis.directory, "/Figures/Figure_1_e.pdf"), width=6.5, height=6.5, useDingbats = F)
...
pdf(paste0(analysis.directory, "/Figures/Figure_1_j.pdf"), width=3.5, height=3.5, useDingbats = F)
