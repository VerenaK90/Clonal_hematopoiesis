...
## and the 2-clone model. To load the parameters obtained with the 2-clone model, we source the file "Plot_fits_heme_WGS_data_2_clone_model.R"

source(paste0(custom.script.directory, "/Analysis_and_figures/Plot_fits_heme_WGS_data_2_clone_model.R"))
...
## To load the parameters obtained without size compensation, we source the file "Plot_fits_heme_WGS_data_no_size_compensation.R"

source(paste0(custom.script.directory, "/Analysis_and_figures/Plot_fits_heme_WGS_data_no_size_compensation.R"))
